...
static constexpr GpioPin PUMP_1 = GPIO_NUM_17;  /// <<- Oil pump number 1
static constexpr GpioPin PUMP_2 = GPIO_NUM_19;  /// <<- Oil pump number 2
...
static constexpr GpioPin LED_COMMON = GPIO_NUM_18; /// <<- Led output common

/// ----------------------------------------------------------------------- ///

/// -------------------------- Usage inputs pins -------------------------- ///

static constexpr GpioPin SPEED_SENSOR   = GPIO_NUM_12;
static constexpr GpioPin BUTTON         = GPIO_NUM_14; 
static constexpr GpioPin VOLTAGE_SENSOR = GPIO_NUM_32; 
